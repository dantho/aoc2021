...
pub fn part1(_input: &()) -> usize {
    ...
    play (100,1000,my_puzzle_input.0,my_puzzle_input.1)
...
pub fn part2(_input: &()) -> usize {
    let my_puzzle_input = (10,7);
    play (3,21,my_puzzle_input.0,my_puzzle_input.1)
}

pub fn play(max_roll: usize, required_to_win: usize, starting_pos1: usize, starting_pos2: usize) -> usize {
    let game_board = 10;
    ...
    loop {
        for player in 0..=1 {
            ...
            *pos = ((*pos + roll_x3) - 1) % game_board + 1;
            ...
            if scores[player] >= required_to_win {break 'game_loop};
        }
    }
...
pub fn dirac_play(max_roll: usize, required_to_win: usize, starting_pos1: usize, starting_pos2: usize) -> usize {
    let game_board = 10;
    let mut player_pos = [starting_pos1, starting_pos2];
    let mut scores = [0; 2];
    let mut die = 0usize; // Not valid roll - initialization only
